...
/**
 * page for adding two imported oil to the cart
 * 
...
public class ImportedOilPage {
	 ...
	 */
	public void AddOil() {
		addItemToCart.addItemToCart(oilsHealthTab, importedOilLink, fuLinMenImage, bellinaImage, addToCartButton);
